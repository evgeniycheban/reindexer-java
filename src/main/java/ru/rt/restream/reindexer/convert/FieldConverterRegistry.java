...
public interface FieldConverterRegistry {
    ...
    /**
     * Registers a global {@link FieldConverter} for the given {@literal type}.
     * This method allows overriding an existing global converter for the given type.
     *
     * @param fieldType the field type to use
     * @param converter the {@link FieldConverter} to use
     */
    void registerGlobalConverter(Class<?> fieldType, FieldConverter<?, ?> converter);
}
