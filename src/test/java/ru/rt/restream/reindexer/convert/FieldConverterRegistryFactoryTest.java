...
public class FieldConverterRegistryFactoryTest {
    ...
    void getFieldConverterWhenClassSpecifiedThenCreated() {
        GenericFieldConverter<String, String> converter = registry
                .getFieldConverter(getField("stringLongConvertField"));
        assertThat(converter, notNullValue());
        assertThat(converter.getConverterClass(), is(StringLongFieldConverter.class));
    }
    ...
    void getFieldConverterWhenClassSpecifiedConverterConfiguredThenConfiguredConverterTakesPrecedence() {
        ...
        GenericFieldConverter<String, String> fieldConverter = registry
                .getFieldConverter(getField("stringLongConvertField"));
        assertThat(fieldConverter, notNullValue());
        assertThat(fieldConverter.getDelegate(), sameInstance(converter));
    }
    ...
    void getFieldConverterWhenClassSpecifiedGlobalConverterConfiguredThenSpecifiedTakesPrecedence() {
        ...
        assertThat(fieldConverter, notNullValue());
        assertThat(fieldConverter.getDelegate(), instanceOf(StringIntegerFieldConverter.class));
    }
    ...
    void registerFieldConverterWhenRegisteredThenOverrides() {
        GenericFieldConverter<String, Long> stringLongFieldConverter = new GenericFieldConverter<>(new StringLongFieldConverter(),
                ConversionUtils.resolveConverterTypePair(StringLongFieldConverter.class));
        registry.registerFieldConverter(TestPojo.class, "stringField", stringLongFieldConverter);
        Field field = getField("stringField");
        GenericFieldConverter<String, String> fieldConverter = registry.getFieldConverter(field);
        assertThat(fieldConverter, notNullValue());
        ...
        assertThat(fieldConverter, notNullValue());
        assertThat(fieldConverter.getDelegate(), sameInstance(stringIntegerFieldConverter));
    }
